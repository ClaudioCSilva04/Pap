...
public class AbrirMochila2 : MonoBehaviour
{
  ...
  public Image pilhaAzul;//imagem da pilha azul
  private bool isTrigger = false;//verifica se esta dentro do trigger(nao esta por default)
  public bool botaoclicadoazul = false;//verifica se o botao azul e clicado
  ...
  private void Update()
  {
    ...
    {
      if (botaoclicadoazul == true)
      {
        inventariosempilhas.gameObject.SetActive(true);
        inventariosemazul.gameObject.SetActive(false);
      }
      inventariosemazul.gameObject.SetActive(true);
  ...
  public void BotaoAzul()//funcao do botaoazul
  {
    botaoclicadoazul = true;//diz que o botao azul foi clicado
    pilhaAzul.gameObject.SetActive(true);//aparece a imagem da pilha azul no canto inferior direito
  }
